...
function make_vsp(frm) {
  open_legacy_mapped(
    frm,
    "ir.industrial_relations.doctype.voluntary_seperation_agreement.voluntary_seperation_agreement.make_vsp_performance",
...
function appeal_performance(frm) {
  open_legacy_mapped(
    frm,
    "ir.industrial_relations.doctype.appeal_against_outcome.appeal_against_outcome.appeal_poor_performance",
    { linked_poor_performance: frm.doc.name },
  );
}
