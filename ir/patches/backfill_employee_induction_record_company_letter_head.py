...
"""Employee Induction Record had no Company/Letter Head fields at all,
unlike most other IR process forms tied to an Employee - every existing
record (and every signed print of one) used the site's default Letter Head
instead of the Employee's own Company's. The doctype now carries and
populates both fields via JS when Employee is picked; this backfills every
